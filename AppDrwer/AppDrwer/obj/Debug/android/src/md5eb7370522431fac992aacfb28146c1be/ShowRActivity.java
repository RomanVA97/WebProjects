...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppDrwer.ShowRActivity, AppDrwer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ShowRActivity.class, __md_methods);
	}


	public ShowRActivity ()
	{
		super ();
		if (getClass () == ShowRActivity.class)
			mono.android.TypeManager.Activate ("AppDrwer.ShowRActivity, AppDrwer, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
